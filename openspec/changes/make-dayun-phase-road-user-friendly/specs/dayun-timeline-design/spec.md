...
The system SHALL render a Dayun summary strip below the Liunian cards with a concise, layered explanation of the selected Dayun. It SHALL make the ten-year composite road condition visually primary and render user-facing phase road and theme guidance as secondary content.
...
- **AND** it SHALL render front-five and back-five phase road labels, calendar ranges, and themes as secondary guidance
- **AND** it SHALL keep Jin Bu Huan ratings and governing Gan/Zhi as supporting information rather than the primary phase conclusion.
